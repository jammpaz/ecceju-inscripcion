...
from app.models import Usuario, ParticipanteData, PreventaCamisetaData
...
def register_admin_in(inscripcion_id, admin):
    ...
    if not inscripcion.is_managed_by(admin):
        ...
        print(
            f"'{admin}' fue agregado a '{inscripcion.localidad}' con exito")
    else:
        print(
            f"'{admin}' ya existe como admin en '{inscripcion.localidad}'")
