...
class ParticipanteIntTestCase(unittest.TestCase):
    ...
    def test_show_a_participante(self):
        ...
        self.assertTrue(str(participante.id)
                        in response.get_data(as_text=True))
        self.assertTrue(
            participante.nombres_completos in response.get_data(
                as_text=True))
        self.assertTrue(participante.sexo in response.get_data(as_text=True))
        self.assertTrue(
            participante.telefono_contacto in response.get_data(
                as_text=True))
        self.assertTrue(str(participante.monto)
                        in response.get_data(as_text=True))
        self.assertTrue(
            participante.numero_deposito in response.get_data(
                as_text=True))
    ...
    def test_index_of_participantes(self):
        ...
        self.assertEqual(response.status_code, 200)
        self.assertTrue(str(participante_1.id)
                        in response.get_data(as_text=True))
        self.assertTrue(
            participante_1.nombres_completos in response.get_data(
                as_text=True))
        self.assertTrue(str(participante_2.id)
                        in response.get_data(as_text=True))
        self.assertTrue(
            participante_2.nombres_completos in response.get_data(
                as_text=True))
    ...
    def test_new_participante(self):
        ...
        self.assertTrue(
            'Telefono de contacto' in response.get_data(
                as_text=True))
        self.assertTrue('Monto' in response.get_data(as_text=True))
        self.assertTrue(
            'Número de depósito' in response.get_data(
                as_text=True))
    ...
    def test_should_return_error_if_monto_is_invalid(self):
        ...
        self.assertTrue(len(filtered_participante) == 0)
        self._assert_static_text(
            'El valor del monto debe ser 25.00 USD', response)
